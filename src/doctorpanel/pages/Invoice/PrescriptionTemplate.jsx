...
const PrescriptionTemplate = ({ open, onClose, data }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex justify-center overflow-y-auto py-10 w-full">
      ...
      <div className="relative flex flex-col bg-white w-auto lg:w-[570px]">

        {/* ================= PRINTABLE AREA ================= */}
        <div ref={invoiceRef} className="bg-white shadow">

          {/* ================= A4 PAGE ================= */}
          {/* <div className="page bg-white max-w-[794px] h-auto rounded-2xl shadow-xl overflow-hidden"> */}
          <div className="page bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div className="px-10 pt-32 pb-10">
              ...
              <div className="flex justify-between border-b border-gray-200 pb-4 mb-6">
                <div>
                  ...
                  <div className="text-sm mt-2 pr-2">
                    <p>Number: <b>{data._id}</b></p>
              ...
              {/* SIGNATURE */}
              <div className="flex justify-between mt-12 no-break">
                <div className="text-left">
                  <p className="font-semibold mb-1">Recommended Tests</p>
                  <p className="text-sm">Blood Test</p>
                  <p className="text-sm">Blood Test</p>
                </div>
                <div className="text-center bottom-0">
                  <div className="border-b w-40 pt-13"></div>
        ...
        {/* ================= ACTION BAR ================= */}
        <div className="bg-white px-6 py-4 border border-gray-200 shadow print:hidden">
